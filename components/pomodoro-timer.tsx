...
function PomodoroTimer() {
  ...
  const handleSwitchSession = () => {
    setState((prevState) => {
      const isWorkSession = state.currentSession === "work";
      return {
        ...prevState,
  ...
  const handleDurationChange = (
    ...
    setState((prevState) => {
      ...
      if (type === "work") {
        ...
        return {
          ...prevState,
          breakDuration: Math.max(60, prevState.breakDuration + durationChange), // Time kam se kam 60 seconds ho
          currentTime:
            prevState.currentSession === "break" // Agar abhi break session chal raha hai tou current time bhi update karo
